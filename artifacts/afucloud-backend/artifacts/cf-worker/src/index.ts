...
// ── API routes ────────────────────────────────────────────────────────────────
// Supabase-compatible paths must be registered before AfuCloud's product
// routes so supabase-js can use api.afuchat.com as its single origin.
app.route("/", supabaseProxyRoutes);
