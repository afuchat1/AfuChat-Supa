...
const styles = StyleSheet.create({
  ...
  replyInputWrap: { flexDirection: "row", alignItems: "flex-end", borderRadius: 24, paddingLeft: 16, paddingRight: 6, paddingVertical: 6, gap: 8, borderWidth: 0 },
  replyInput: { flex: 1, fontSize: 15, fontFamily: "Inter_400Regular", lineHeight: 20, maxHeight: 100, borderWidth: 0, outlineStyle: "none" as any },
