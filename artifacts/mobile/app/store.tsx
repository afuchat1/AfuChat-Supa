...
function SparkleEffect({ visible }: { visible: boolean }) {
  const sparks = Array.from({ length: 12 }, (_, i) => {
    ...
    const colors = ["#FF9500", "#AF52DE", "#34A853", "#FF3B30", "#007AFF"];
...
const styles = StyleSheet.create({
  ...
  coinBtnText: { color: "#34A853", fontSize: 13, fontFamily: "Inter_700Bold" },
  ...
  newBadge: { backgroundColor: "#34A853", paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6 },
