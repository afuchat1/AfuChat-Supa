...
const styles = StyleSheet.create({
  ...
  inputField: { flex: 1, borderRadius: 0, paddingHorizontal: 14, paddingVertical: 9, maxHeight: 120 },
  ...
  sheetInput: { borderRadius: 0, padding: 14, fontSize: 15, fontFamily: "Inter_400Regular" },
