...
const st = StyleSheet.create({
  ...
  chatNameRow: { flex: 1, flexDirection: "row", alignItems: "center", gap: 2, minWidth: 0, overflow: "hidden" },
  chatName: { fontSize: 15, fontFamily: "Inter_600SemiBold", flexShrink: 1, flexGrow: 0 },
