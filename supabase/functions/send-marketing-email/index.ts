...
<span style="color:#00BCD4;font-size:18px;font-weight:700;margin-right:12px;">1</span>
<span style="color:#444;font-size:14px;">Complete your profile with a photo and bio</span>
</td></tr>
<tr><td style="padding:12px 0;border-bottom:1px solid #f0f0f0;">
<span style="color:#00BCD4;font-size:18px;font-weight:700;margin-right:12px;">2</span>
<span style="color:#444;font-size:14px;">Find and follow friends in Contacts</span>
</td></tr>
<tr><td style="padding:12px 0;border-bottom:1px solid #f0f0f0;">
<span style="color:#00BCD4;font-size:18px;font-weight:700;margin-right:12px;">3</span>
<span style="color:#444;font-size:14px;">Share your first post on Discover</span>
</td></tr>
<tr><td style="padding:12px 0;">
<span style="color:#00BCD4;font-size:18px;font-weight:700;margin-right:12px;">4</span>
...
<a href="https://afuchat.com" style="display:inline-block;background:#00BCD4;color:#fff;text-decoration:none;padding:14px 32px;border-radius:12px;font-size:15px;font-weight:600;">Open AfuChat</a>
</div>
...
<div style="text-align:center;margin:0 0 24px;">
<a href="https://afuchat.com" style="display:inline-block;background:#00BCD4;color:#fff;text-decoration:none;padding:14px 32px;border-radius:12px;font-size:15px;font-weight:600;">See What's New</a>
</div>
...
<a href="${customData.ctaUrl}" style="display:inline-block;background:#00BCD4;color:#fff;text-decoration:none;padding:14px 32px;border-radius:12px;font-size:15px;font-weight:600;">${customData.ctaText}</a>
</div>` : ""}`),
      };
