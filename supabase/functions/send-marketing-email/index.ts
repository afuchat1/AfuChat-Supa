...
<a href="https://afuchat.com" style="color:#00C2CB;text-decoration:none;font-size:13px;font-weight:600;margin:0 8px;">Website</a>
<span style="color:#ddd;">|</span>
<a href="https://afuchat.com/help" style="color:#00C2CB;text-decoration:none;font-size:13px;font-weight:600;margin:0 8px;">Help Center</a>
<span style="color:#ddd;">|</span>
<a href="https://afuchat.com/privacy" style="color:#00C2CB;text-decoration:none;font-size:13px;font-weight:600;margin:0 8px;">Privacy</a>
<span style="color:#ddd;">|</span>
<a href="https://afuchat.com/terms" style="color:#00C2CB;text-decoration:none;font-size:13px;font-weight:600;margin:0 8px;">Terms</a>
</td></tr>
<tr><td style="text-align:center;padding-bottom:6px;">
<p style="color:#999;font-size:12px;margin:0;line-height:1.6;">Need help? Contact us at <a href="mailto:support@afuchat.com" style="color:#00C2CB;text-decoration:none;">support@afuchat.com</a></p>
</td></tr>
...
<span style="color:#00C2CB;font-size:18px;font-weight:700;margin-right:12px;">1</span>
<span style="color:#444;font-size:14px;">Complete your profile with a photo and bio</span>
</td></tr>
<tr><td style="padding:12px 0;border-bottom:1px solid #f0f0f0;">
<span style="color:#00C2CB;font-size:18px;font-weight:700;margin-right:12px;">2</span>
<span style="color:#444;font-size:14px;">Find and follow friends in Contacts</span>
</td></tr>
<tr><td style="padding:12px 0;border-bottom:1px solid #f0f0f0;">
<span style="color:#00C2CB;font-size:18px;font-weight:700;margin-right:12px;">3</span>
<span style="color:#444;font-size:14px;">Share your first post on Discover</span>
</td></tr>
<tr><td style="padding:12px 0;">
<span style="color:#00C2CB;font-size:18px;font-weight:700;margin-right:12px;">4</span>
...
<a href="https://afuchat.com" style="display:inline-block;background:#00C2CB;color:#fff;text-decoration:none;padding:14px 32px;border-radius:12px;font-size:15px;font-weight:600;">Open AfuChat</a>
</div>
...
<div style="text-align:center;margin:0 0 24px;">
<a href="https://afuchat.com" style="display:inline-block;background:#00C2CB;color:#fff;text-decoration:none;padding:14px 32px;border-radius:12px;font-size:15px;font-weight:600;">See What's New</a>
</div>
...
<a href="${customData.ctaUrl}" style="display:inline-block;background:#00C2CB;color:#fff;text-decoration:none;padding:14px 32px;border-radius:12px;font-size:15px;font-weight:600;">${customData.ctaText}</a>
</div>` : ""}`),
      };
